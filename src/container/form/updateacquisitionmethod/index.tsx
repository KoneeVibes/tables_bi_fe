...
export const UpdateAcquisitionMethodForm: React.FC<BaseFormPropsType> = ({
	formDetails,
	setFormDetails,
}) => {
	const methods = [
	...
	return (
		<UpdateAcquisitionMethodFormWrapper>
			<Box>
				<BaseLegend>How did you hear about TablesBI?</BaseLegend>
				<Typography
					variant="body1"
					fontFamily={"Inter"}
					fontWeight={400}
			...
			>
				{methods.map((method, index) => {
					return (
						<Grid key={index} flexGrow={1} size={{ mobile: 12, miniTablet: 6 }}>
							<BaseFieldSet>
								<BaseLabel
									sx={{
										display: "flex",
								...
								>
									...
									<BaseInput
										...
										inputProps={{
											checked:
												formDetails["acquisitionMethod"].includes(method),
										}}
