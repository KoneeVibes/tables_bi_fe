...
export const UpdatePurposeForm: React.FC<SignUpFormPropsType> = ({ formDetails, setFormDetails }) => {
    const intents = ["Explore and analyze my business data", "Create dashboards without writing SQL", "Share insights with my team", "Understand trends using filters and aggregations", "Track performance over time", "Generate quick exports for reporting"];
    ...
    return (
        <UpdatePurposeFormWrapper>
            <Box>
                <BaseLegend>
                    What are you looking to do with TablesBI?
                </BaseLegend>
                <Typography
                    variant="body1"
                    fontFamily={"Inter"}
