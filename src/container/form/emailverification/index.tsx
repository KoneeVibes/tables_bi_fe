	...
	return (
		<EmailVerificationFormWrapper>
			...
			<Box>
				...
				>
					We sent a 6-digit code to {formDetails.email}, please enter the code
					below.
				</Typography>
			</Box>
			<Grid
			...
			>
				{otp.map((digit, index) => (
					<Grid key={index} flexGrow={1} size={{ mobile: 2 }}>
						<BaseFieldSet>
							<BaseInput
								required
								value={digit}
								...
								border={
									error
										? "1px solid var(--form-field-error-border-color)"
										: focusedIndex === index
										? "1px solid var(--primary-color)"
										: "1px solid var(--border-color)"
								}
								bgcolor={
									error ? "var(--form-field-error-color)" : "transparent"
								}
							/>
						</BaseFieldSet>
					</Grid>
